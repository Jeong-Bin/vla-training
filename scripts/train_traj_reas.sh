...
#
# 사용:
# GPUS=0,1,2,3,4,5,6,7 scripts/train_traj_reas.sh --vlm-mode lora --epochs 10 --batch-size 1 --grad-accum 1 --maneuver-lateral-thr -1.0 --reasoning-types decision,counterfactual --gate-weight 1.0 --selective-view --temporal-clip
#
